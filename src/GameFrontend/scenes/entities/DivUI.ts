...
export class DivUI implements Entity {
    ...
    constructor() {
        let bottomdiv = new Div("backgroundDiv", "position:fixed;background-color:#1a1818;height: 60%; width: 60%;z-index: 4;top: 0;left: 0; bottom:0; right:0;margin:auto;opacity:0.6;border-radius:15px")
        ...
        let div = new Div("identifier", "display:flex;justify-content:center;align-items:center;position: fixed;background-color:#1a1818;opacity:0.2; height: 60%; width: 60%;z-index: 5;top: 0;left: 0; bottom:0; right:0;margin:auto;opacity:0.6;border-radius:15px", 
    ...
    generateButton(id: string, path:string, characterName: string) {
        ...
        let containerDiv = new Div(divId, "display:flex;position:relative;flex-direction:column;justify-content:center;align-items: center;background-color:#1a1818;height: 100%; width: 100%;z-index: 4;border-radius:15px", button, text)
        return containerDiv
