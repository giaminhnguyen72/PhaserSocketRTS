...
export class Treant implements Entity {
    components: [TimedSpriteSheet3d, Transform, Script,MultiplayerSyncronizer<Treant, Data>];
    id?: number | undefined;
    scene!: Scene ;
    className: string = "Treant";
    constructor() {
        ...
        transform.vel.x = 0
        transform.vel.y = 0
        let sprite = new TimedSpriteSheet3d("/images/Characters/Treant_Side_S.png", {
            rot:0,
            dim:{
                length: 64,
                height:64
        ...
        // })
        let sync = new MultiplayerSyncronizer<Treant, Data>(this, (data: Data) =>{
