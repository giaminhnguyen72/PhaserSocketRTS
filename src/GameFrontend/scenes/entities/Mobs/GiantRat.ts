...
export class GiantRat implements Entity {
    components: [TimedSpriteSheet3d, Transform, Script,MultiplayerSyncronizer<GiantRat, Data>];
    id?: number | undefined;
    scene!: Scene ;
    className: string = "GIANTRAT";
    ...
    constructor() {
        ...
        transform.vel.x = 0
        transform.vel.y = 0
        let sprite = new TimedSpriteSheet3d("/images/Characters/GiantRat_S.png", {
            rot:0,
            dim:{
                length: 64,
                height:64
        ...
        // })
        let sync = new MultiplayerSyncronizer<GiantRat, Data>(this, (data: Data) =>{
