...
export const GARGOYLECLASS = "GARGOYLE"
export class Gargoyle implements Entity {
    components: [TimedSpriteSheet3d, Transform, Script,MultiplayerSyncronizer<Gargoyle, Data>,BoxCollider];
    id?: number | undefined;
    scene!: Scene ;
    className: string = GARGOYLECLASS;
    ...
    constructor() {
        ...
        transform.vel.x = 0
        transform.vel.y = 0
        let sprite = new TimedSpriteSheet3d("/images/Characters/Gargoyle_S.png", {
            rot:0,
            dim:{
                length: 64,
                height:64
        ...
        let collider = new BoxCollider({dim:{length:38, height: 45},pos: {x:0,y:0,z:5}, rot: 0}, (col) => {
        ...
        // })
        let sync = new MultiplayerSyncronizer<Gargoyle, Data>(this, (data: Data) =>{
