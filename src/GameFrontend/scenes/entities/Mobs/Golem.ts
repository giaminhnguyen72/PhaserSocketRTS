...
export class Golem implements Entity {
    components: [TimedSpriteSheet3d, Transform, Script,MultiplayerSyncronizer<Golem, Data>];
    id?: number | undefined;
    scene!: Scene ;
    ...
    constructor() {
        ...
        transform.vel.x = 0
        transform.vel.y = 0
        let sprite = new TimedSpriteSheet3d("/images/Characters/Golem_Side_S.png", {
            rot:0,
            dim:{
                length: 64,
                height:64
        ...
        // })
        let sync = new MultiplayerSyncronizer<Golem, Data>(this, (data: Data) =>{
