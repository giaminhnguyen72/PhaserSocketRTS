...
export class MindFlayer implements Entity {
    ...
    constructor() {
        ...
        transform.vel.x = 0
        transform.vel.y = 0
        let sprite = new TimedSpriteSheet3d("/images/Characters/MindFlayer_S.png", {
            rot:0,
            dim:{
                length: 64,
                height:64
        ...
        script.setInit((system) =>{
            ...
            system.addSuperClasses(script, "Livable", "Moveable", "SpriteSheet", "Enemy", "MINDFLAYER")
        ...
        // })
        let sync = new MultiplayerSyncronizer<MindFlayer, Data>(this, (data: Data) =>{
