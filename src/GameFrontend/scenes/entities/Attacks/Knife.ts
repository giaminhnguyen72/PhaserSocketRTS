...
export class Knife implements Entity {
    components: [Sprite3d, Transform, MultiplayerSyncronizer<Knife, Data>, Script,...Component[]];
    id?: number | undefined;
    scene!: Scene ;
    ...
    let sync = new MultiplayerSyncronizer<Knife, Data>(this, (data: Data) =>{
