...
export class Slowball implements Entity {
    components: [TimedSpriteSheet3d, Transform, MultiplayerSyncronizer<Slowball, Data>, Script, BoxCollider];
    id?: number | undefined;
    scene!: Scene ;
    className: string = "SLOWBALL";
    constructor(owner: number =0, pos: Vector3 = {x:0, y:0, z:0}, dir: Vector3= {x:0,y:0,z:0}, ) {
        ...
        let sprite = new TimedSpriteSheet3d("/images/Projectiles/Slowball_S.png", {
            dim:{
                length: 32,
                height:32
            },
    ...
    let sync = new MultiplayerSyncronizer<Slowball, Data>(this, (data: Data) =>{
                    ...
                    if (i instanceof Script) {
                        ...
                        switch (currType) {
                            case 0:
                                ...
                                let slowC = new Slow()
                                slowC.duration = 5000
                                slowC.multiplier = 0.5
                                slowC.scriptID = i.componentId as number
                                i.system.operations.addEntity(0).addComponent<Slow>(Slow,slowC)
