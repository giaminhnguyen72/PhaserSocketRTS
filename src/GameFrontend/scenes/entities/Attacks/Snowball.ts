...
export class Snowball implements Entity {
    components: [Sprite3d, Transform, MultiplayerSyncronizer<Snowball, Data>, Script, BoxCollider];
    id?: number | undefined;
    scene!: Scene ;
    className: string = "SNOWBALL";
    ...
    },"/images/Projectiles/Snowball.png", )
    let sync = new MultiplayerSyncronizer<Snowball, Data>(this, (data: Data) =>{
