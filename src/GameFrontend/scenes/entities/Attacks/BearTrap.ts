...
export class BearTrap implements Entity {
    components: [Sprite3d, Transform, MultiplayerSyncronizer<BearTrap, Data>, Script,...Component[]];
    id?: number | undefined;
    scene!: Scene ;
    className: string = "BEARTRAP";
    ...
    let sync = new MultiplayerSyncronizer<BearTrap, Data>(this, (data: Data) =>{
