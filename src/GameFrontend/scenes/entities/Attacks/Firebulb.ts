...
export class Firebulb implements Entity {
    components: [Sprite3d, Transform, MultiplayerSyncronizer<Firebulb, Data>,Script, BoxCollider]
    id?: number | undefined;
    scene!: Scene;
    className: string = "FIREBULB";
    ...
    },"/images/Projectiles/Firebulb.png", )
    let sync = new MultiplayerSyncronizer<Firebulb, Data>(this, (data: Data) =>{
