...
export class HealBall implements Entity {
    components: [TimedSpriteSheet3d, Transform, MultiplayerSyncronizer<HealBall, Data>, Script, BoxCollider];
    id?: number | undefined;
    scene!: Scene ;
    className: string = "HEALBALL";
    constructor(owner: number =0, pos: Vector3 = {x:0, y:0, z:0}, dir: Vector3= {x:0,y:0,z:0}, ) {
        ...
        let sprite = new TimedSpriteSheet3d("/images/Projectiles/HealBall_S.png", {
            dim:{
                length: 32,
                height:32
            },
    ...
    let sync = new MultiplayerSyncronizer<HealBall, Data>(this, (data: Data) =>{
