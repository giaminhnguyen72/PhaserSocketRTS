...
export class Bandage implements Entity {
    components: [Sprite3d, Transform, MultiplayerSyncronizer<Bandage, Data>, Script,...Component[]];
    id?: number | undefined;
    scene!: Scene ;
    className: string = "BANDAGE";
    constructor(owner: number =0, pos: Vector3 = {x:0, y:0, z:1}, dir: Vector3= {x:0,y:0,z:0}, ) {
    ...
    let sync = new MultiplayerSyncronizer<Bandage, Data>(this, (data: Data) =>{
        ...
        script.properties.set("Duration", 100000)
        script.properties.set("Type", 2)
